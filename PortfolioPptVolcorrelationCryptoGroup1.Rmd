...
```{r}
p1 <- cbind(min_var1[1:3], sqrt(8395)*min_var1[4], sqrt(8395)*min_var1[5], sqrt(8395)*min_var1[10])
p2 <- cbind(min_var2[1:3], sqrt(8395)*min_var2[4], sqrt(8395)*min_var2[6], sqrt(8395)*min_var2[11])
p3 <- cbind(min_var3[1:3], sqrt(8395)*min_var3[4], sqrt(8395)*min_var3[7], sqrt(8395)*min_var3[12])
p4 <- cbind(min_var4[1:3], sqrt(8395)*min_var4[4], sqrt(8395)*min_var4[8], sqrt(8395)*min_var4[13])
p5 <- cbind(min_mad[1:3], sqrt(8395)*min_mad[4], sqrt(8395)*min_mad[9], sqrt(8395)*min_mad[14])
xtable(t(rbind(as.numeric(p1), as.numeric(p2), as.numeric(p3), as.numeric(p4), as.numeric(p5))), digits = 5)
```

```{r}
p1 <- cbind(max_sr1[1:3], sqrt(8395)*max_sr1[4], sqrt(8395)*max_sr1[5], sqrt(8395)*max_sr1[10])
p2 <- cbind(max_sr2[1:3], sqrt(8395)*max_sr2[4], sqrt(8395)*max_sr2[6], sqrt(8395)*max_sr2[11])
p3 <- cbind(max_sr3[1:3], sqrt(8395)*max_sr3[4], sqrt(8395)*max_sr3[7], sqrt(8395)*max_sr3[12])
p4 <- cbind(max_sr4[1:3], sqrt(8395)*max_sr4[4], sqrt(8395)*max_sr4[8], sqrt(8395)*max_sr4[13])
p5 <- cbind(max_sr5[1:3], sqrt(8395)*max_sr5[4], sqrt(8395)*max_sr5[9], sqrt(8395)*max_sr5[14])
xtable(t(rbind(as.numeric(p1), as.numeric(p2), as.numeric(p3), as.numeric(p4), as.numeric(p5))), digits = 5)
```
